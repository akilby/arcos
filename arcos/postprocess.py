...
def final_clean(Reports_dict, folder, print_outlier_threshold=6):
    """
    ...
    if not os.path.isdir(folder):
        os.mkdir(folder)
        if not os.path.isdir(os.path.join(folder, 'CACHES')):
            os.mkdir(os.path.join(folder, 'CACHES'))
    ...
    pickle_dump(report_final_dict,
                os.path.join(folder, 'CACHES', 'report_final_dict.pkl'))
